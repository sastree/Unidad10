...
public class secreto {
	...
	public static void main(String[] args) {
		...
		// DECODIFICADOR
				...
				|| texto.contains(":/·") || texto.contains("!&:") || texto.contains("¿(?") || texto.contains("-@º")
				|| texto.contains("-:@") || texto.contains("-·]") || texto.contains("·#/") || texto.contains("·$·")
				|| texto.contains("~··") || texto.contains("=¿:") || texto.contains("!|@")|| texto.contains("|·|")|| texto.contains("/·/")
				|| texto.contains("])[")|| texto.contains("&=&")|| texto.contains("&=&")|| texto.contains("|||")|| texto.contains("ººº")|| texto.contains("-/-")
